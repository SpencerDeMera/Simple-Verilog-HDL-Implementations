...
* **Key Concept:** * **State Toggling:** Combines timing and output logic into a single block. 
...
* **Key Concept:** * **BCD Logic:** Uses a Binary Coded Decimal counter that resets at 9 rather than 15.
